        ...
        Platform.runLater( new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    document.addAuthor( ApplicationUtilities.getInstance().getActiveUser().getName() );
                    document.addCreator( ApplicationUtilities.getInstance().getCompany() );
                    document.addTitle( "Circus Solution Report" );
