...
public class AttractionEditor extends DefaultEditor<Attraction> {
    public AttractionEditor(EditorCallback<Attraction> callback) {
        super(callback);
    ...
    @Override
    protected void setSource(Attraction source) {
        if (source.getId() != 0) {
    ...
    private void initComponents() {
        setTitle("Editor da Atração");
        setHeaderText("Editor da Atração");
